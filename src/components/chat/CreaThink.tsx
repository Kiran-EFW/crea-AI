...
import { VanillaMarkdownParser } from "./CreaMarkdownParser";
import { CustomTagState } from "./stateTypes";
import { CreaTokenSavings } from "./CreaTokenSavings";

interface CreaThinkProps {
  node?: any;
  children?: React.ReactNode;
}

export const CreaThink: React.FC<CreaThinkProps> = ({ children, node }) => {
  ...
  const tokenSavingsMatch =
    typeof children === "string"
      ? children.match(
          /^crea-token-savings\?original-tokens=([0-9.]+)&smart-context-tokens=([0-9.]+)$/,
        )
      : null;
