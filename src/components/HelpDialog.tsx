...
`;
      ...
      const githubIssueUrl = `https://github.com/crea-sh/crea/issues/new?title=${encodedTitle}&labels=bug,filed-from-app&body=${encodedBody}`;
      ...
      IpcClient.getInstance().openExternalUrl(
        "https://github.com/crea-sh/crea/issues/new",
      );
    } finally {
      setIsLoading(false);
    }
...
`;
    ...
    const githubIssueUrl = `https://github.com/crea-sh/crea/issues/new?title=${encodedTitle}&labels=support&body=${encodedBody}`;
