...
## System Information
- Dyad Version: ${debugInfo.creaVersion}
...
`;
      ...
      const githubIssueUrl = `https://github.com/crea-sh/crea/issues/new?title=${encodedTitle}&labels=bug,filed-from-app,client-error&body=${encodedBody}`;
