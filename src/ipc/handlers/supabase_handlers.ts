...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a Crea app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a Crea app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.crea.ai/api/connect-supabase/login",
      });
      logger.info(
