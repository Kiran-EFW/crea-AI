...
export const SCALIX_API_ENDPOINTS = {
  ...
  // Scalix Gateway - Optimized routing
  GATEWAY: "https://llm-gateway.scalix.ai/v1",

  // Scalix Pro services
  USER_INFO: "https://llm-gateway.scalix.ai/v1/user/info",
  USER_BUDGET: "https://llm-gateway.scalix.ai/v1/user/budget",
  USAGE_STATS: "https://llm-gateway.scalix.ai/v1/user/stats",

  // Templates and community
  TEMPLATES: "https://api.scalix.ai/v1/templates",

  // Auto-updates
  UPDATES: "https://api.scalix.ai/v1/update",

  // Logs and diagnostics
  LOGS_UPLOAD: "https://upload-logs.scalix.ai/generate-upload-url",
} as const;
