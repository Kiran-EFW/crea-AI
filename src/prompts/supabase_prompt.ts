...
<crea-add-dependency packages="@supabase/supabase-js"></crea-add-dependency>
...
<crea-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<crea-execute-sql description="Get all users">
SELECT * FROM users;
</crea-execute-sql>
...
<crea-execute-sql description="Enable RLS on table">
...
<crea-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</crea-execute-sql>

   **User-specific Data Access:**
<crea-execute-sql description="Create user-specific data access policy">
...
<crea-execute-sql description="Create table">
-- Create table
...
<crea-execute-sql description="Create profiles table with proper RLS security">
...
<crea-execute-sql description="Optional: Add public read access (only if needed)">
...
<crea-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <crea-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <crea-write> changes for edge functions.
...
<crea-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
