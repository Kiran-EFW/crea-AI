...
<scalix-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</scalix-write>

<scalix-add-dependency packages="@supabase/supabase-js"></scalix-add-dependency>
...
<scalix-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<scalix-execute-sql description="Get all users">
SELECT * FROM users;
</scalix-execute-sql>
...
<scalix-execute-sql description="Enable RLS on table">
...
<scalix-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</scalix-execute-sql>

   **User-specific Data Access:**
<scalix-execute-sql description="Create user-specific data access policy">
...
<scalix-execute-sql description="Create table">
-- Create table
...
<scalix-execute-sql description="Create profiles table with proper RLS security">
...
<scalix-execute-sql description="Optional: Add public read access (only if needed)">
...
<scalix-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <scalix-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <scalix-write> changes for edge functions.
...
<scalix-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
...
<scalix-add-integration provider="supabase"></scalix-add-integration>
