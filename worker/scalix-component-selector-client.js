(() => {
  ...
  function onClick(e) {
    ...
    window.parent.postMessage(
      {
        type: "crea-component-selected",
        id: state.element.dataset.creaId,
        name: state.element.dataset.creaName,
      },
      "*",
    );
  }
  ...
  window.addEventListener("message", (e) => {
    ...
    if (e.data.type === "activate-crea-component-selector") activate();
    if (e.data.type === "deactivate-crea-component-selector") deactivate();
  });
  ...
  function initializeComponentSelector() {
    ...
    setTimeout(() => {
      if (document.body.querySelector("[data-crea-id]")) {
        window.parent.postMessage(
          {
            type: "crea-component-selector-initialized",
          },
          "*",
        );
